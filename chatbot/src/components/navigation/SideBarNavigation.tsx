...
export default function SideBar(props: any) {
    ...
    return (
        <>
            <button onClick={() => props.setSideBarVisible(true)} aria-controls="default-sidebar" type="button" className="bg-gray-800 sm:absolute sm:top-0 sm:left-0  z-40  border rounded-sm   inline-flex items-center p-2 mt-2 ms-3 text-sm  focus:outline-none focus:ring-2 text-gray-400 hover:bg-gray-700 focus:ring-gray-600">
